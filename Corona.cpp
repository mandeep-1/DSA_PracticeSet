...
int main()
{
string fever,cough,fatigue,sneezing,aches,nose,throat,diarea,headache,breath; //declaring the
...
cin >> breath;
if(fever== "COMMON" && fatigue=="SOMETIMES" && cough== "COMMON" && sneezing == "NO"
&& aches== "SOMETIMES" && nose=="RARE" && throat=="SOMETIMES" && diarea=="RARE" &&
headache=="SOMETIMES" && breath=="SOMETIMES")
{
cout << "You have coronavirus!!!";
}
else if(fever== "RARE" && fatigue=="SOMETIMES" && cough== "MILD" && sneezing == "COMMON"
&& aches== "COMMON" && nose=="COMMON" && throat=="COMMON" && diarea=="NO" &&
headache=="RARE" && breath=="NO")
{
cout << "You have cold";
}
else if(fever== "COMMON" && fatigue=="COMMON" && cough== "COMMON" && sneezing ==
"NO" && aches== "COMMON" && nose=="SOMETIMES" && throat=="SOMETIMES" &&
diarea=="SOMETIMES" && headache=="COMMON" && breath=="NO")
{
cout << "You have Flu";
}
else{
